...
public class FRM_CONSULTA_MARCA extends javax.swing.JFrame {
conectaBD cnx=new conectaBD();
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        if (jtbcargo.getColumnModel().getColumnCount() > 0) {
            jtbcargo.getColumnModel().getColumn(0).setMinWidth(20);
            jtbcargo.getColumnModel().getColumn(0).setMaxWidth(60);
        }

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "BUSCAR POR MARCA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 0, 255))); // NOI18N
 ...
 private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
   String sql="SELECT*FROM V_MANTENIMIENTO_MARCA";
   icono();
...
String nom=this.jtxtnombre.getText();
  String sql ="SELECT*FROM V_MANTENIMIENTO_MARCA WHERE nombre LIKE '%"+nom+"%'";
  try{
   LlenarTabla(sql);
  }
  catch(Exception e){
...
this.dispose();  // TODO add your handling code here:
 ...
 public static void main(String args[]) {
  ...
  try {
   ...
   java.util.logging.Logger.getLogger(FRM_CONSULTA_MARCA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
  ...
  java.awt.EventQueue.invokeLater(new Runnable() {
   public void run() {
    new FRM_CONSULTA_MARCA().setVisible(true);
   }
  });
 }
